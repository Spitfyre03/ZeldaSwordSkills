...
import zeldaswordskills.client.render.entity.*;
import zeldaswordskills.entity.mobs.*;
...
import zeldaswordskills.entity.projectile.*;
...
public class ZSSEntities
{
	...
	private static void registerEntities() {
		...
		registerEntity(EntityCucco.class, "cucco", ++modEntityIndex, 80, 0xFFFFFF, 0xFF3300);
	...
	public static void registerRenderers() {
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityCucco.class, new RenderCucco.Factory());
